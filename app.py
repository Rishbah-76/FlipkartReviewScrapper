...
class threadClass:
    ...
    def run(self):
        ...
        collection_name = self.scrapper_object.getReviewsToDisplay(expected_review=self.expected_review,
                                                                   searchString=self.searchString, username='flipkartserver',
                                                                   password='flipkartauth',
...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            mongoClient = MongoDBManagement(username='flipkartserver', password='flipkartauth')
